  ...
  return (
    <div className="flex justify-center mt-10 px-16 py-16">
      ...
      <div className="card h-[25rem] transition-all duration-[0.2s] relative cursor-pointer">
        <div className="card-inner w-[20rem] sm:w-[30rem] md:w-[45rem] p-5 px-28 h-[inherit] shadow-[0_0_10px_rgba(0,0,0,0.25)] backdrop-blur-[10px] rounded-3xl bg-[#ffffff0d]">
          ...
          >
            <div className="flex">
              <svg
                className="absolute top-[140px] ml-3 h-[1.5em] w-[1.5em] fill-[white]"
            ...
            <div className="flex mt-3">
              <RiLockPasswordFill className="absolute top-[204px] ml-3 h-[1.3em] w-[1.3em] fill-[white]" />
              <input
                name="Password"
                autoComplete="off"
                id="password"
            ...
            <section>
              <ul className="flex gap-0 sm:gap-28 md:gap-36 justify-around text-white font-poppins w-[20rem] sm:w-96">
                <li>
                  <Link className="active:text-slate-300 md:text-lg text-sm w-[200px]" href="/Register">Sign up</Link>
                </li>
                <li>
                  <Link className="active:text-slate-300 md:text-lg text-sm" href="/">Forgot Password?</Link>
                </li>
              </ul>
            </section>
